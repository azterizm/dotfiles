...
keyset("n", "<leader>gp", "<Plug>(coc-diagnostic-prev)", {silent = true})
keyset("n", "<leader>gn", "<Plug>(coc-diagnostic-next)", {silent = true})
keyset("n", "gd", "<Plug>(coc-definition)", {silent = true})
keyset("n", "gy", "<Plug>(coc-type-definition)", {silent = true})
keyset("n", "gi", "<Plug>(coc-implementation)", {silent = true})
keyset("n", "gr", "<Plug>(coc-references)", {silent = true})
keyset("n", "gh", '<CMD>lua _G.show_docs()<CR>', {silent = true})
keyset("n", "<leader>im", '<CMD>CocCommand editor.action.organizeImport<CR>', {silent = true})
